                ...
                <div class="card-body">
                    <form method="POST" action="{{route('products.update',['product'=>$product->id])}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row py-2">
                            <label for="name" class="col-sm-2 col-form-label">產品名稱<span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="name" name="name" value="{{$product->name}}" required>
                            </div>
                        </div>
                        <div class="form-group row py-2">
                            <label for="price" class="col-sm-2 col-form-label">產品價格<span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input type="namber" min=0 class="form-control" id="price" name="price" value="{{$product->price}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row py-2">
                            ...
                            <div class="col-sm-10">
                                <img src="{{Storage::url($product->image_url)}}" alt="" width="200" height="200">
                            </div>
                        </div>

                        <div class="form-group row py-2">
                            <label for="image_url" class="col-sm-2 col-form-label">主要圖片(重新上傳)<span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row py-2">
                            <label for="image_urls" class="col-sm-2 col-form-label">其他圖片(上傳)</label>
                            <div class="col-sm-10">
